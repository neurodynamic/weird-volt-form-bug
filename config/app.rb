...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'controller-bug-demo-app.com'
  config.app_name = 'Controller_bug_demo_app'
  config.mailer.from = 'Controller_bug_demo_app <no-reply@controller-bug-demo-app.com>'
  ...
  #
  config.app_secret = 'yJM0yhZkUO9iQiT71V1z1fsskyNvXLtSEuRZmTTqgpgu1e40npg8U14VT1q_ADd5HNM'
